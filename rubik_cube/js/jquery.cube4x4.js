...
$.fn.cube = function(options){
 ...
 //method for parsing moves string into individual moves
    function parse(moves){
        ...
        var allowed = ["U","u","R","r","D","d","L","l","F","f","B","b","m", "e", "s","X","Y","Z","2","'" ,"Q"];
        ...
        switch(plane){
            case "y":
                switch(depth){
                    case 0:
                        return [
                             _cube[0].get(0),  _cube[1].get(0),  _cube[2].get(0),  _cube[3].get(0),
                            _cube[16].get(0), _cube[17].get(0), _cube[18].get(0), _cube[19].get(0),
                            _cube[32].get(0), _cube[33].get(0), _cube[34].get(0), _cube[35].get(0),
							_cube[48].get(0), _cube[49].get(0), _cube[50].get(0), _cube[51].get(0)
                        ];
                    case 1:
                        return [
                             _cube[4].get(0),  _cube[5].get(0),  _cube[6].get(0),  _cube[7].get(0),
                            _cube[20].get(0), _cube[21].get(0), _cube[22].get(0), _cube[23].get(0),
                            _cube[36].get(0), _cube[37].get(0), _cube[38].get(0), _cube[39].get(0),
							_cube[52].get(0), _cube[53].get(0), _cube[54].get(0), _cube[55].get(0)
                        ];
                    case 2:
                        return [
                             _cube[8].get(0),  _cube[9].get(0), _cube[10].get(0), _cube[11].get(0),
                            _cube[24].get(0), _cube[25].get(0), _cube[26].get(0), _cube[27].get(0),
                            _cube[40].get(0), _cube[41].get(0), _cube[42].get(0), _cube[43].get(0),
							_cube[56].get(0), _cube[57].get(0), _cube[58].get(0), _cube[59].get(0)
                        ];
					case 3:
						return [
							_cube[12].get(0), _cube[13].get(0), _cube[14].get(0), _cube[15].get(0),
							_cube[28].get(0), _cube[29].get(0), _cube[30].get(0), _cube[31].get(0),
							_cube[44].get(0), _cube[45].get(0), _cube[46].get(0), _cube[47].get(0),
							_cube[60].get(0), _cube[61].get(0), _cube[62].get(0), _cube[63].get(0)
						];
                }
            case "x":
                switch(depth){
                    case 0:
                        return [
                            _cube[12].get(0),  _cube[8].get(0),  _cube[4].get(0),  _cube[0].get(0),
                            _cube[28].get(0), _cube[24].get(0), _cube[20].get(0), _cube[16].get(0),
                            _cube[44].get(0), _cube[40].get(0), _cube[36].get(0), _cube[32].get(0),
							_cube[60].get(0), _cube[56].get(0), _cube[52].get(0), _cube[48].get(0)
                        ];
                    case 1:
                        return [
                            _cube[13].get(0),  _cube[9].get(0),  _cube[5].get(0),  _cube[1].get(0),
                            _cube[29].get(0), _cube[25].get(0), _cube[21].get(0), _cube[17].get(0),
                            _cube[45].get(0), _cube[41].get(0), _cube[37].get(0), _cube[33].get(0),
							_cube[61].get(0), _cube[57].get(0), _cube[53].get(0), _cube[49].get(0)
                        ];
                    case 2:
                        return [
                            _cube[14].get(0), _cube[10].get(0), _cube[6].get(0), _cube[2].get(0),
                            _cube[30].get(0), _cube[26].get(0), _cube[22].get(0), _cube[18].get(0),
                            _cube[46].get(0), _cube[42].get(0), _cube[38].get(0), _cube[34].get(0),
							_cube[62].get(0), _cube[58].get(0), _cube[54].get(0), _cube[50].get(0)
                        ];
					case 3:
						return [
							_cube[15].get(0), _cube[11].get(0),  _cube[7].get(0),  _cube[3].get(0),
							_cube[31].get(0), _cube[27].get(0), _cube[23].get(0), _cube[19].get(0),
							_cube[47].get(0), _cube[43].get(0), _cube[39].get(0), _cube[35].get(0),
							_cube[63].get(0), _cube[59].get(0), _cube[55].get(0), _cube[51].get(0)
						];
                }
            case "z":
                switch(depth){
   ...
   //method for generating the to array from
    ...
    function generateToArray(cubits, move){
        ...
        if(move == "cw"){
            //clockwise
            return [
              cubits[12],  cubits[8],  cubits[4], cubits[0],
              cubits[13],  cubits[9],  cubits[5], cubits[1],
              cubits[14],  cubits[10], cubits[6], cubits[2],
			  cubits[15],  cubits[11], cubits[7], cubits[3]					
            ];
        }

        //counter clockwise
        return [
				cubits[3], cubits[7], cubits[11],cubits[15], 
                cubits[2], cubits[6], cubits[10],cubits[14],
                cubits[1], cubits[5], cubits[9], cubits[13],
                cubits[0], cubits[4], cubits[8], cubits[12]
            ];
    }
	...
	_ref.turn = function(move, rotation){
		...
		switch(move){
            ...
            case "l'":
				...
				$(from).each(function(){
					var pos = $(this).data("pos");
					pos.ox = 90;  //the auther made a mistake here too. it should be 90,not -90
				});

				break;

			case "F":
				var from = getCubits("z", 3);
                var to = generateToArray(from, "ccw");
          ...
          case "X":
				var f0 = getCubits("x", 3);
                var f1 = getCubits("x", 2);
                var f2 = getCubits("x", 1);
                var f3 = getCubits("x", 0);
                var from = f0.concat(f1).concat(f2).concat(f3);
				
				var t0 = generateToArray(f0, "ccw");
                var t1 = generateToArray(f1, "ccw");
                var t2 = generateToArray(f2, "ccw");
                var t3 = generateToArray(f3, "ccw");
                var to = t0.concat(t1).concat(t2).concat(t3);
...
//*****************************************************************/
	...
	function createCube(){
		...
		options.cubit = {
			width: options.size.width/4,
			height: options.size.height/4
		};

		for(var z=-1.5*options.cubit.width; z<options.cubit.width*2; z+=options.cubit.width){
			...
			for(var i=0; i<16; i++){
				...
				switch(i){
					case 0:
						point.x -= 1.5*options.cubit.width;
						point.y -= 1.5*options.cubit.height;
						break;

					case 1:
						point.x -= 0.5*options.cubit.width;
						point.y -= 1.5*options.cubit.height;
						break;
					...
					case 4:
						point.x -= 1.5*options.cubit.width;
						point.y -= 0.5*options.cubit.height;
						break;
