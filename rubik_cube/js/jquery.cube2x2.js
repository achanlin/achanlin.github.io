...
$.fn.cube = function(options){
    ...
    function parse(moves){
        ...
        var allowed = ["U","R","D","L","F","B","X","Y","Z","2","'"];
        ...
        switch(plane){
            case "y":
                switch(depth){
                    case 0:
                        return [
                            _cube[0].get(0), _cube[1].get(0), 
                            _cube[4].get(0), _cube[5].get(0)
                        ];
                    case 1:
                        return [
                            _cube[2].get(0), _cube[3].get(0),
                            _cube[6].get(0), _cube[7].get(0)
                        ];
            ...
            case "x":
                switch(depth){
                    case 0:
                        return [
                            _cube[2].get(0), _cube[0].get(0),
                            _cube[6].get(0), _cube[4].get(0)
           
                        ];
                    case 1:
                        return [
                            _cube[3].get(0), _cube[1].get(0),
                            _cube[7].get(0), _cube[5].get(0)
	...
	function createCube(){
		...
		options.cubit = {
			width: options.size.width/2,
			height: options.size.height/2
		};

		for(var z=-options.cubit.width*0.5; z<options.cubit.width; z+=options.cubit.width){
			...
			for(var i=0; i<4; i++){
				...
				switch(i){
					case 0:
						point.x -= options.cubit.width*0.5;
						point.y -= options.cubit.height*0.5;
						break;
