...
/*		var vCorrectAnswer=document.getElementById("correct_answer").innerHTML;
		var nCorrectAnswer=parseInt(vCorrectAnswer); */
	...
	function finish()
	{
		...
		var myText=document.getElementById("statistics");
